  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        ...
        className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-sm border border-teal-500 border-opacity-50 bg-teal-500 bg-opacity-50 shadow-lg shadow-black/[0/3] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[40rem] sm:rounded-full"
      ></motion.div>
            ...
            >
              <Link
                ...
                className={clsx(
                  ...
                  {
                    "text-black": activeSection === link.hash,
                  }
                )}
              >
                {link.label}
